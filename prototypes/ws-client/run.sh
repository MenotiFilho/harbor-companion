#!/usr/bin/env bash
# Run the WS-client logic prototype. Uses `dart` from PATH, or DART_SDK env, or
# a locally-downloaded SDK at /tmp/opencode/dart/dart-sdk.
set -euo pipefail
cd "$(dirname "$0")"
...
exec "$DART_BIN" run bin/ws_client_proto.dart
